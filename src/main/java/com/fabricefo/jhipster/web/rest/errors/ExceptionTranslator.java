package com.fabricefo.jhipster.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.fabricefo.jhipster.service.EmailAlreadyUsedException ||
            ex instanceof com.fabricefo.jhipster.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.fabricefo.jhipster.service.InvalidPasswordException
